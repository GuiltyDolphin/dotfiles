...
- new shell command =diff-directories= for summarising directory diffs

- new shell command =my-size-all= for summarising sizes of
  files and directories in current directory

- new shell command =top-level-files-directories-in-zip-archive= for
  getting number of top-level files and directories in an archive
...
- =xscreensaver= will now lock the screen
